...
import com.github.onsdigital.flumpet.helpers.Configuration;
...
public class FtpPublisherTest {
    ...
    public void tearDown() {
        ...
        Configuration.unset(FtpPublisher.FTP_HOST);
        Configuration.unset(FtpPublisher.FTP_PORT);
        Configuration.unset(FtpPublisher.FTP_USER);
    }
